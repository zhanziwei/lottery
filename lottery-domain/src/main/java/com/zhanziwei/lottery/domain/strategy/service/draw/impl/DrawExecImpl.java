package com.zhanziwei.lottery.domain.strategy.service.draw.impl;

import com.alibaba.fastjson.JSON;
import com.zhanziwei.lottery.domain.strategy.service.algorithm.IDrawAlgorithm;
import com.zhanziwei.lottery.domain.strategy.service.draw.AbstracDrawBase;
 ...
 */
@Service("drawExec")
public class DrawExecImpl extends AbstracDrawBase {
    private Logger logger = LoggerFactory.getLogger(DrawExecImpl.class);
    @Override
    protected List<String> queryExcludeAwardIds(Long strategyId) {
        List<String> awardList = strategyRepository.queryNoStockAwardList(strategyId);
